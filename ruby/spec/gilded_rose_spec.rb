...
describe GildedRose do
  describe '#update_quality' do
    ...
    context 'Sulfuras, Hand of Ragnaros' do
      ...
      it 'Does not decrease sell in number' do
        items = [Item.new('Sulfuras, Hand of Ragnaros', rand(1..100), rand(1..50))]
    ...
    context 'Backstage passes to a TAFKAL80ETC concert' do
      it 'increases the quality by 3 when there are 5 days or less left to sell' do
      ...
      it 'increases the quality by 2 of when there are 10 days or less left to sell' do
        items = [Item.new('Backstage passes to a TAFKAL80ETC concert', rand(6..10), rand(1..48))]
        expect { GildedRose.new(items).update_quality }.to change { items[0].quality }.by(2)
      end

      it 'quality is 0 when there are 0 days left to sell' do
